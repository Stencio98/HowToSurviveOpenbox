...
Questo passaggio non è fondamentale, quindi sentiti libero di fare come preferisci, io ho creato un Makefile (devi avere il comando make per utilizzarlo) nella directory /home/user/ in cui ho inserito i comandi che uso più spesso, una alternativa è editare il file /home/user/.bashrc per personalizzare comandi e poterli utilizzare ovunque ti trovi e non solo in /home/user, se non sai cosa siano il comando make e il file .bashrc vai un attimo a cercare sul web.
